...
const HTML = fs.readFileSync(path.join(ROOT, "public/rubric.html"), "utf8").replace(/\s+/g, " ");
...
test("rubric carries CLAIM-RUB-016 verbatim with a census link", () => {   // SITE-R-035
  ...
  assert.ok(HTML.includes(c.text.replace(/\s+/g, " ")), "registered text rendered verbatim on rubric.html");
