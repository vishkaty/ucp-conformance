...
def main():
    ...
    print("tls-check gate:", "PASS — CHK-051 + IDL-053 + DISC-001 + NEG-018/SEC-004 "
          "are sound (clean on their goldens, kill their mutants, honest on plain "
          "HTTP)" if ok else "FAIL")
