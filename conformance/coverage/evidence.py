...
# the four TARGET-FACING classes (a live server or a fixture instance was graded); the
# two A3 classes grade the corpus / our own algorithm — matrix.integrity splits on this
TARGET_FACING = ("live-wire", "fixture-schema", "fixture-crypto", "self-referenced")
...
_RANK = {"live-wire": 5, "fixture-schema": 4, "fixture-crypto": 3, "self-referenced": 2,
         "register-selfcheck": 1, "reference-impl": 0}
