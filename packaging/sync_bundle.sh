...
cp "$SRC/checks/engine.py" "$SRC/checks/merchant.py" "$SRC/checks/merchant_checks.py" \
   "$SRC/checks/merchant_checks_01_23.py" "$SRC/checks/tls_check_01_11_01_23.py" "$DST/checks/"
