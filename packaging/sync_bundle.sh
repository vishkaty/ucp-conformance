...
# pinned skip populations (checks/expected_skips_*.json, PLAN-v3 §2.3): runner data
# validate_bundle.py requires; the glob is guarded so a tree without any stays valid.
