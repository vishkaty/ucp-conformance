...
> the honest percentage moved from 93/88/88 to **85/87/87**. Higher denominator, truer number.
...
spec-truth citation gate + a completeness reconciliation).** 187 kill-rate-validated
...
> classified (version-scoped, multi-class). Result: **87 / 87 / 85% accounted** (against a
