...
- **Merchant platforms** — you expose a UCP agentic interface over your catalog, cart,
  ...
  actually discover and buy from you. **196 kill-rate-validated checks.**
- **Shopping agents** — you build a shopping-orchestration AI that carts and checks out
  ...
  see. **42 checks (45 defects modeled); watch six fail live at [spck.dev/sandbox](https://spck.dev/sandbox).**
...
Currently **196 kill-rate-validated checks** account for **90% of 2026-04-08**, **87% of
